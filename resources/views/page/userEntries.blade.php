...
<div class="panel panel-info">
    <div class="panel-body">
        <div class="row">
            <div class="col-md-3">{!! trans('label.name') !!}</div>
            <div class="col-md-9">{!! $user->name !!}</div>
            <div class="col-md-3">{!! trans('label.email') !!}</div>
            <div class="col-md-9">{!! $user->email !!}</div>
            <div class="col-md-3">{!! trans('label.num_entry') !!}</div>
            <div class="col-md-9">{!! $entries->count() !!}</div>
